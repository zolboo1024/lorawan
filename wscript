...
def build(bld):
    ...
    module.source = [
        ...
        'model/secure-network-server.cc',
        'model/secure-network-status.cc',
        'model/secure-end-device-status.cc',
        'model/secure-network-scheduler.cc',
        'model/secure-network-controller.cc',
        'model/secure-network-controller-components.cc',
        'model/lora-utils.cc',
    ...
    headers.source = [
        ...
        'model/secure-network-server.h',
        'model/secure-network-status.h',
        'model/secure-end-device-status.h',
        'model/secure-network-controller-components.h',
        'model/secure-network-controller.h',
        'model/secure-network-scheduler.h',
