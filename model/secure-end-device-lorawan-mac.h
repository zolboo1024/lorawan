...
#ifndef SECURE_END_DEVICE_LORAWAN_MAC_H
#define SECURE_END_DEVICE_LORAWAN_MAC_H
...
/**
 * Class representing the MAC layer of a Secure (authentication enabled) LoRaWAN device.
 */
class SecureEndDeviceLorawanMac : public EndDeviceLorawanMac
{
public:
  static TypeId GetTypeId (void);

  SecureEndDeviceLorawanMac ();
  virtual ~SecureEndDeviceLorawanMac ();
