...
#ifndef SECURE_FRAME_HEADER_H
#define SECURE_FRAME_HEADER_H
...
/**
 * This class represents a secure version of the Frame header (FHDR) used in a LoraWAN network.
 *
 ...
 */
class SecureFrameHeader : public Header
{
public:
  SecureFrameHeader ();
  ~SecureFrameHeader ();
  ...
  /**
   * Deserialize the contents of the buffer into a SecureFrameHeader object.
   *
...
template<typename T>
Ptr<T>
SecureFrameHeader::GetMacCommand ()
{
