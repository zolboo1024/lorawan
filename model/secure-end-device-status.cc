...
#include "ns3/secure-end-device-status.h"
...
NS_LOG_COMPONENT_DEFINE ("SecureEndDeviceStatus");

TypeId
SecureEndDeviceStatus::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::SecureEndDeviceStatus")
                          .SetParent<Object> ()
                          .AddConstructor<SecureEndDeviceStatus> ()
                          .SetGroupName ("lorawan");
  return tid;
}

SecureEndDeviceStatus::SecureEndDeviceStatus (LoraDeviceAddress endDeviceAddress,
                                  Ptr<SecureEndDeviceLorawanMac> endDeviceMac)
    : m_reply (SecureEndDeviceStatus::Reply ()),
...
SecureEndDeviceStatus::SecureEndDeviceStatus ()
{
...
uint8_t
SecureEndDeviceStatus::GetFirstReceiveWindowSpreadingFactor ()
{
  NS_LOG_FUNCTION_NOARGS ();
...
double
SecureEndDeviceStatus::GetFirstReceiveWindowFrequency ()
{
  NS_LOG_FUNCTION_NOARGS ();
...
uint8_t
SecureEndDeviceStatus::GetSecondReceiveWindowOffset ()
{
  NS_LOG_FUNCTION_NOARGS ();
...
double
SecureEndDeviceStatus::GetSecondReceiveWindowFrequency ()
{
  NS_LOG_FUNCTION_NOARGS ();
...
Ptr<Packet>
SecureEndDeviceStatus::GetCompleteReplyPacket (void)
{
  NS_LOG_FUNCTION_NOARGS ();
...
bool
SecureEndDeviceStatus::NeedsReply (void)
{
  NS_LOG_FUNCTION_NOARGS ();
...
LorawanMacHeader
SecureEndDeviceStatus::GetReplyMacHeader ()
{
  NS_LOG_FUNCTION_NOARGS ();
...
LoraFrameHeader
SecureEndDeviceStatus::GetReplyFrameHeader ()
{
  NS_LOG_FUNCTION_NOARGS ();
...
Ptr<Packet>
SecureEndDeviceStatus::GetReplyPayload (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_reply.payload->Copy ();
}

Ptr<SecureEndDeviceLorawanMac>
SecureEndDeviceStatus::GetMac (void)
{
  return m_mac;
}

SecureEndDeviceStatus::ReceivedPacketList
SecureEndDeviceStatus::GetReceivedPacketList ()
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
SecureEndDeviceStatus::SetFirstReceiveWindowSpreadingFactor (uint8_t sf)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
SecureEndDeviceStatus::SetFirstReceiveWindowFrequency (double frequency)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
SecureEndDeviceStatus::SetSecondReceiveWindowOffset (uint8_t offset)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
SecureEndDeviceStatus::SetSecondReceiveWindowFrequency (double frequency)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
SecureEndDeviceStatus::SetReplyMacHeader (LorawanMacHeader macHeader)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
SecureEndDeviceStatus::SetReplyFrameHeader (LoraFrameHeader frameHeader)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
SecureEndDeviceStatus::SetReplyPayload (Ptr<Packet> replyPayload)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
SecureEndDeviceStatus::InsertReceivedPacket (Ptr<Packet const> receivedPacket, const Address &gwAddress)
{
  NS_LOG_FUNCTION_NOARGS ();
...
SecureEndDeviceStatus::ReceivedPacketInfo
SecureEndDeviceStatus::GetLastReceivedPacketInfo (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  auto it = m_receivedPacketList.rbegin ();
  if (it != m_receivedPacketList.rend ())
    ...
    {
      return SecureEndDeviceStatus::ReceivedPacketInfo ();
    }
}

Ptr<Packet const>
SecureEndDeviceStatus::GetLastPacketReceivedFromDevice (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  auto it = m_receivedPacketList.rbegin ();
  if (it != m_receivedPacketList.rend ())
...
void
SecureEndDeviceStatus::InitializeReply ()
{
  NS_LOG_FUNCTION_NOARGS ();
  m_reply = Reply ();
...
void
SecureEndDeviceStatus::AddMACCommand (Ptr<MacCommand> macCommand)
{
  m_reply.frameHeader.AddCommand (macCommand);
}

std::map<double, Address>
SecureEndDeviceStatus::GetPowerGatewayMap (void)
{
...
std::ostream &
operator<< (std::ostream &os, const SecureEndDeviceStatus &status)
{
  ...
  for (auto j = status.m_receivedPacketList.begin (); j != status.m_receivedPacketList.end (); j++)
    {
      SecureEndDeviceStatus::ReceivedPacketInfo info = (*j).second;
      SecureEndDeviceStatus::GatewayList gatewayList = info.gwList;
      Ptr<Packet const> pkt = (*j).first;
      os << pkt << " " << gatewayList.size () << std::endl;
      for (SecureEndDeviceStatus::GatewayList::iterator k = gatewayList.begin (); k != gatewayList.end ();
           k++)
        {
          SecureEndDeviceStatus::PacketInfoPerGw infoPerGw = (*k).second;
