...
#ifndef SECURE_END_DEVICE_STATUS_H
#define SECURE_END_DEVICE_STATUS_H
...
class SecureEndDeviceStatus : public Object
{
...
public:
  ...
  /*******************************************/
  /* Proper SecureEndDeviceStatus class definition */
  /*******************************************/

  static TypeId GetTypeId (void);

  SecureEndDeviceStatus ();
  SecureEndDeviceStatus (LoraDeviceAddress endDeviceAddress,
                   Ptr<SecureEndDeviceLorawanMac> endDeviceMac);
  virtual ~SecureEndDeviceStatus ();
  ...
  Ptr<SecureEndDeviceLorawanMac> GetMac (void);
   ...
   * device.
   */
  SecureEndDeviceStatus::ReceivedPacketInfo GetLastReceivedPacketInfo (void);
  ...
  friend std::ostream& operator<< (std::ostream& os, const SecureEndDeviceStatus& status);
...
private:
  ...
  Ptr<SecureEndDeviceLorawanMac> m_mac;   //!< Pointer to the MAC layer of this device
};
}
