/*
 * This script simulates a simple secure network in which one end device sends one
...
NS_LOG_COMPONENT_DEFINE ("SecureLorawanNetworkExample");

int main (int argc, char *argv[])
{

  // Set up logging
  LogComponentEnable ("SecureLorawanNetworkExample", LOG_LEVEL_ALL);
